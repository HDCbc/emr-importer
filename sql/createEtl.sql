...
CREATE UNLOGGED TABLE IF NOT EXISTS etl.entry_state (source_table text, emr_entry_id text, state text, effective_date timestamp without time zone, emr_reference text);
